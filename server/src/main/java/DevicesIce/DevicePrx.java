...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    default String info()
    {
        return info(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String info(java.util.Map<String, String> context)
    {
        return _iceI_infoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> infoAsync()
    {
        return _iceI_infoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> infoAsync(java.util.Map<String, String> context)
    {
        return _iceI_infoAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_infoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "info", null, sync, null);
