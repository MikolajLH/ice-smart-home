...
public interface CameraPrx extends DevicePrx
{
    ...
    {
        return getFrame(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Frame getFrame(java.util.Map<String, String> context)
    {
        return _iceI_getFrameAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Frame> getFrameAsync()
    {
        return _iceI_getFrameAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Frame> getFrameAsync(java.util.Map<String, String> context)
    {
        return _iceI_getFrameAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Frame> _iceI_getFrameAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Frame> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getFrame", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     Frame ret;
                     ret = Frame.ice_read(istr);
                     return ret;
                 });
        return f;
    }
